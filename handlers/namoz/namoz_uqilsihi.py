...
async def qaytar_handler(callback: CallbackQuery):
    await callback.message.answer(text="Namoz <a href='https://t.me/mukammal_namoz/27'>Bizning kanal</a>", reply_markup=admin_keyboard.tanlash_)
...
async def massaeg(messaga: Message):
    await messaga.answer("Namoz <a href='https://t.me/mukammal_namoz/27'>Bizning kanal</a>   ", reply_markup=admin_keyboard.tanlash_)
...
<a href='https://t.me/mukammal_namoz/59'>Bizning kanal📢</a>
TAHORAT
...
async def bomdod(callback: CallbackQuery):
    await callback.message.delete()
    await callback.message.answer(text="Bomdod (fors.) — erta tong payti, sahar va shu paytda oʻqiladigan namoz. Bomdod namozi kun chiqish taraf yorishganidan boshlab to kun chiqqunga qadar oʻqiladi. Bamdod namozi ikki rakat sunnat va ikki rakat farzdan iborat. Erta tongda oʻqilgan namozning savobi qolgan namozlarga qaraganda kattaroq boʻladi. Namoz oʻqish musulmonlarning farzi hisoblanadi. <a href='https://t.me/mukammal_namoz/54'>Bizning kanal </a>", reply_markup=admin_keyboard.erkak_namoz)
...
async def peshin(callback: CallbackQuery):
    await callback.message.delete()
    await callback.message.answer(text="""
Peshin (fors.) — kunning yarmi oʻtgan payti va shu paytda oʻqiladigan namoz. Peshin namozi toʻrt rakat sunnat, toʻrt rakat farz va ikki rakat sunnatdan iborat. Peshin namozi Quyosh qiyomdan ogʻa boshlashidan to asr namozining vaqti kirguncha ado etiladi. <a href='https://t.me/mukammal_namoz/55'>Bizning kanal</a>""", reply_markup=admin_keyboard.erkak_namoz)
...
<a href='https://t.me/mukammal_namoz/56'>Bizning kanal📢</a>""", reply_markup=admin_keyboard.erkak_namoz)
...
<a href='https://t.me/mukammal_namoz/57'>Bizning kanal📢</a>""", reply_markup=admin_keyboard.erkak_namoz)
...
<a href='https://t.me/mukammal_namoz/58'>Bizning kanal📢</a>""", reply_markup=admin_keyboard.erkak_namoz)
...
<a href='https://t.me/mukammal_namoz/60'>Bizning kanal📢</a>""", reply_markup=admin_keyboard.erkak_namoz)
...
<a href='https://t.me/mukammal_namoz/61'>Bizning kanal📢</a>""", reply_markup=admin_keyboard.erkak_namoz)
...
<a href='https://t.me/mukammal_namoz/63'>Bizning kanal📢</a>
...
<a href='https://t.me/mukammal_namoz/64'>Bizning kanal📢</a>
""", reply_markup=admin_keyboard.ayol_namoz)
...
async def asr(callback: CallbackQuery):
    ...
    await callback.message.answer(text="""
Asr namozi - Alloh taolo tomonidan farz qilingan namozlardan biri. Bu namozni musulmon kishi har kuni oʻqiydi. Ushbu namoz 4 rakat boʻlib faqat farzdan iborat.
<a href='https://t.me/mukammal_namoz/65'>Bizning kanal📢</a>
...
async def shom(callback: CallbackQuery):
    ...
    await callback.message.answer(text="""
Shom — Quyosh botib, qorongʻulik boshlangan payt va shu vaqtda oʻqiladigan namoz. Shom namozi Quyosh botgandan boshlab, magʻrib ufqidagi qizil shafaqning koʻrinmay ketadigan vaqtigacha ado etiladi, uch rakat farz va ikki rakat sunnatdan iborat.
<a href='https://t.me/mukammal_namoz/66'>Bizning kanal📢</a>
""", reply_markup=admin_keyboard.ayol_namoz)
...
<a href='https://t.me/mukammal_namoz/67'>Bizning kanal📢</a>
""", reply_markup=admin_keyboard.ayol_namoz)
...
async def istixora(callback: CallbackQuery):
    ...
    await callback.message.answer(text="""
Istixora (baʼzan istihora ham deyiladi; arabcha: الاستخارة) — ikki rakaatdan iborat namoz. Ushbu namozdan so'ng musulmon kishi Allohdan maʼlum bir masala boʻyicha toʻgʻri qaror qabul qilishda yordam berishini soʻraydi.
<a href='https://t.me/mukammal_namoz/70'>Bizning kanal📢</a>
""", reply_markup=admin_keyboard.ayol_namoz)
...
<a href='https://t.me/mukammal_namoz/69'>Bizning kanal📢</a>
""", reply_markup=admin_keyboard.ayol_namoz)
...
<a href='https://t.me/c/2342502353/24'>Bizning kanal📢</a> 
""", reply_markup=admin_keyboard.jamoat)
...
<a href='https://t.me/c/2342502353/25'>Bizning kanal📢</a> 
""", reply_markup=admin_keyboard.jamoat)
